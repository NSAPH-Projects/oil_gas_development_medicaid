...
write.csv(tab3_n, "/n/dominici_nsaph_l3/Lab/projects/oil_gas_development_medicaid/Results/manuscriptResults/tab3_n.csv")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods13_mh_dems.txt")
...
write.csv(tab1, "/n/dominici_nsaph_l3/Lab/projects/oil_gas_development_medicaid/Results/manuscriptResults/table1_demographics.csv", row.names = FALSE)
