...
# helpful function for exporting model tables (fixest results)
...
## Remove states with zero oil OR gas production during this time
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods1.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods1_2.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods1_3_a.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods1_3_b.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods2_4_a.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods2_4_b.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods5.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/example_counties.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods1_6.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods2_7.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods8.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods1_3_6_8_mh_only.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods9.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods2_4_7_9_mh_only.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods10.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods11.txt")
...
# Test what happens if we don't include years with major drops
...
#Also tested zero inflated models and did not find significant improvement in fit
#plm_schiz_nb <- glm.nb(schizophrenia_psychotic_disorders_hospitalizations ~ boom_year25_2 + bust_year25_2 + year, data = merge)
#plm_schiz_znb <- zeroinfl(schizophrenia_psychotic_disorders_hospitalizations ~ boom_year25_2 + bust_year25_2 + year, data = merge)
...
####### NOTE: Model sets 13, 14, 15, 17 are the ones in the final manuscript ##########
...
## N values
ntable(plm_mh13_female, merge_female)
ntable(plm_mh13_male, merge_male)
ntable(plm_mh13_white, merge_white)
ntable(plm_mh13_black, merge_black)
ntable(plm_mh13_latine, merge_latine)
ntable(plm_mh13_19to44, merge_19to44)
ntable(plm_mh13_45to64, merge_45to64)
ntable(plm_mh13_65plus, merge_65plus)
...
##### Set 13: Negative binomial models, no covariates. County/year FE. boom/bust threshold at 25%. Contemporaneous indicator w/carry through. Stratifed by Urban/Rural ######
...
##### Set 15: Negative binomial models, no covariates. state/year FE. boom/bust threshold at 25%. Contemporaneous indicator w/carry through. Stratified by demographics #####
...
##### Set 15: Negative binomial models, no covariates. state/year FE. boom/bust threshold at 25%. Contemporaneous indicator w/carry through. Stratified by urban/rural #####
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods16_mh.txt")
...
sink("oil_gas_development_medicaid/Results/manuscriptResults/plm_mods16_mh_newReference.txt")
