...
########################################################################################
# INPUT FILES   : oilgascounty_1_long_an.csv
...
dat00 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2000.csv"))
dat01 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2001.csv"))
dat02 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2002.csv"))
dat03 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2003.csv"))
dat04 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2004.csv"))
dat05 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2005.csv"))
dat06 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2006.csv"))
dat07 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2007.csv"))
dat08 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2008.csv"))
dat09 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2009.csv"))
dat10 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2010.csv"))
dat11 <- fread(paste0(analyticDat, "mental_health_hospitalizations_2011.csv"))
...
## Add in stateFIPS/abbreviations 

state_names <- read.csv(paste0(localDat, "state_name_fips.csv"))
...
merge <- merge(merge, state_names[,c("state_fips_complete","State.Abbreviation")], by = "state_fips_complete", all = TRUE)
...
# Removing Alaska, Hawaii, any states with 0 for oilsum and gassum, and states without outcome data
...
length(unique(merge$residence_county)) 
...
#### Add in economic data for sensitivity analysis #####
...
dim(merge_income) 
length(unique(merge_income$residence_county)) 
